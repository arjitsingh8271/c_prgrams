 /*  C Program to write a simple menu driven C program using switch statement and suitable loop to find
          i) Area of a Circle
         ii) Circumference of a Circle
        iii) Area of a Equilateral triangle
         iv) Area of a Square
          v) To find odd or even
 */  
